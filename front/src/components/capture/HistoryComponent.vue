...
<template>
  <div class="history-container">
    <div
      class="history"
      :class="{ 'mini-mode': !displayed, 'floating-mode': windowHeight < 580 }"
    >
      <h4 class="title">
        <i
          class="icon-history baku-button"
          @click="reloadProject(projectId)"
        ></i>
        <span>Historique</span>
        <i
          class="icon-chevron-right baku-button"
