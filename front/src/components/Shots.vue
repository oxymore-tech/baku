  ...
  <div class="shots">
    <div id="movie-header">
      <p style="display: flex; align-items: center;">
        Statut du film :
        <b-switch style="margin-left: 10px" :disabled="!canUnLock" :value="movie.locked"
                  @input="lockMovie(!movie.locked)">{{ movie.locked ? 'Verrouillé' :
          'Déverrouillé'}}
        </b-switch>
      </p>
    ...
    <div class="shot-cards-container">
      <div
        ...
        <b-dropdown position="is-bottom-right" aria-role="list" class="shot-menu"
                    @click.native.stop>
          ...
          >
            <i class="icon-grid baku-button"></i> Déplacer le plan
          </b-dropdown-item>
          <b-dropdown-item
