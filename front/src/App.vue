...
<!--          <b-dropdown-item class aria-role="listitem" v-if="this.activeShotId">-->
          <b-dropdown-item class aria-role="listitem" :disabled="!this.activeShotId || $route.name === 'captureShot'">
            <div class="option-logo" @click="activateShot()">
